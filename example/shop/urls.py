...
urlpatterns = [
    ...
    path('orders/<int:order_id>/success/', views_3ds.payment_success_3ds_view, name='payment_success_3ds'),
    ...
    path('subscriptions/<int:subscription_id>/', views.subscription_detail_view, name='subscription_detail'),
]
